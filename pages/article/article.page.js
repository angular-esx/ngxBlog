...
export var articlePage = ngCore.Component({
  ...
  styles: [":host(.xblog-article)>.xblog-article-content-section{margin:5rem 0}:host(.xblog-article)>.xblog-article-content-section p{margin:0}:host(.xblog-article)>.xblog-article-content-section .section-heading{margin:1rem 0}:host(.xblog-article)>.xblog-article-related-posts-section-title{text-align:center}:host(.xblog-article)>.xblog-article-related-posts-section{margin:3rem 0}"],
  directives: [
    ngxPortalHostDirective,
    NGX_GRID_DIRECTIVES,
    NGX_CARD_DIRECTIVES,

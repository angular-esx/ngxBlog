  ...
  function _init(context){
    ...
    for (var i = 2; i <= 10; i++) {
      _articles.push({
        id: i,
        title: 'Article 0' + i,
        description: 'This is description of Article 0' + i,
        cover: 'resources/images/xblog-home-cover.jpg',
        postedDate: 'August 24, 2014',
        relatedPosts: [],
        routeName: 'Article'
    ...
    for (i = 1; i <= 6; i++) {
      _articles[0].relatedPosts.push(_articles[i]);
    }
  }
}
